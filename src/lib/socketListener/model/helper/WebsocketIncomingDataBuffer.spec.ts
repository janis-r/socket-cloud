import {WebsocketIncomingDataBuffer} from "./WebsocketIncomingDataBuffer";
import {WebsocketDataFrame} from "../../data/WebsocketDataFrame";

describe("websocket incoming data buffer", () => {

    let dataBuffer: WebsocketIncomingDataBuffer;
    beforeEach(() => dataBuffer = new WebsocketIncomingDataBuffer());
    ...
    it("Can read fragmented messages", async () => {
        ...
        const parsedMessages = new Array<WebsocketDataFrame>();
